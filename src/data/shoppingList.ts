    ...
    categories: [
      {
        title: 'Frutta e Verdura',
        items: [
          { id: 'b6-banane', name: 'Banane', quantity: '~375 g' },
          { id: 'b6-pomodori', name: 'Pomodori', quantity: '~380 g' },
          { id: 'b6-cavolfiore', name: 'Cavolfiore', quantity: '~387 g' },
          { id: 'b6-spinaci', name: 'Spinaci', quantity: '~125 g' },
          { id: 'b6-spinacino', name: 'Spinacino', quantity: '~100 g' },
          { id: 'b6-valeriana', name: 'Valeriana', quantity: '~75 g' },
          { id: 'b6-carote', name: 'Carote', quantity: '~62 g' },
          { id: 'b6-cipolla', name: 'Cipolla', quantity: '~67 g' },
          { id: 'b6-aglio', name: 'Aglio', quantity: '~11 g' },
          { id: 'b6-cipollotto', name: 'Cipollotto', quantity: '~45 g' },
          { id: 'b6-lattuga', name: 'Lattuga', quantity: '~38 g' },
          { id: 'b6-limone', name: 'Limone', quantity: '~20 g' },
          { id: 'b6-germogli', name: 'Germogli mungo', quantity: '~25 g' }
        ]
      },
      {
        title: 'Proteine',
        items: [
          { id: 'b6-petto', name: 'Petto di pollo', quantity: '~325 g (+75 g HP)' },
          { id: 'b6-salmone', name: 'Salmone filetto', quantity: '~150 g' },
          { id: 'b6-manzo', name: 'Manzo macinato', quantity: '~150 g' },
          { id: 'b6-tofu-duro', name: 'Tofu duro', quantity: '~100 g (+180 g HP)' },
          { id: 'b6-tofu-aff', name: 'Tofu affumicato', quantity: '~50 g (+150 g HP)' },
          { id: 'b6-uova', name: 'Uova intere', quantity: 'Circa 3 uova' }
        ]
      },
      {
        title: 'Frigo',
        items: [
          { id: 'b6-latte-mandorle', name: 'Latte di mandorle', quantity: '~400 ml' },
          { id: 'b6-yogurt', name: 'Yogurt', quantity: '~60 g' },
          { id: 'b6-yogurt-greco', name: 'Yogurt greco', quantity: '~100 g' },
          { id: 'b6-yogurt-0', name: 'Yogurt greco 0%', quantity: '~50 g' },
          { id: 'b6-panna-acida', name: 'Panna acida', quantity: '~60 g' },
          { id: 'b6-cheddar', name: 'Cheddar', quantity: '~56 g' },
          { id: 'b6-spalmabile', name: 'Formaggio spalmabile', quantity: '~28 g' },
          { id: 'b6-panna-fresca', name: 'Panna fresca', quantity: '~60 ml' }
        ]
      }
    ],
    hpCorrections: [
      'Skyr: ~1.000 g (blocco con più skyr)',
      'Whey: ~90 g',
      'Petto di pollo: +~75 g',
      'Tofu duro: +~180 g',
      'Tofu affumicato: +~150 g',
      'Albumi: +~200 g',
      'Usa ~100 g di banana in meno.'
    ],
    mealPrepSteps: [
      'È il blocco con più skyr: porziona 4 snack e la quota per il muesli in anticipo.',
      'Due smoothie HP: prepara le due dosi pesate da 25 g di whey.',
      'Giorno 24 cavolfiore al formaggio in versione originale: niente pollo extra.',
      'Curry cavolfiore: tofu extra cotto e cubettato.',
      'Nuggets e salmone restano originali.'
    ],
    storageAdvice: 'Acquista il salmone lo stesso giorno del consumo o abbattuto/surgelato.'
  },
  {
    id: 'block-25-28',
    daysRange: 'Giorni 25–28',
    startDay: 25,
    endDay: 28,
    categories: [
      {
        title: 'Frutta e Verdura',
        items: [
          { id: 'b7-banane', name: 'Banane', quantity: '~225 g' },
          { id: 'b7-pomodori', name: 'Pomodori', quantity: '~240 g' },
          { id: 'b7-spinaci', name: 'Spinaci', quantity: '~225 g' },
          { id: 'b7-funghi', name: 'Funghi', quantity: '~167 g' },
          { id: 'b7-patatedolci', name: 'Patate dolci', quantity: '~112 g' },
          { id: 'b7-zucchine', name: 'Zucchine', quantity: '~115 g' },
          { id: 'b7-carote', name: 'Carote', quantity: '~125 g' },
          { id: 'b7-cipolla', name: 'Cipolla', quantity: '~73 g' },
          { id: 'b7-aglio', name: 'Aglio', quantity: '~11 g' },
          { id: 'b7-cipollotti', name: 'Cipollotti', quantity: '~27 g' },
          { id: 'b7-limone', name: 'Limone', quantity: '~47 g' },
          { id: 'b7-germogli', name: 'Germogli mungo', quantity: '~50 g' }
        ]
      },
      {
        title: 'Proteine',
        items: [
          { id: 'b7-manzo', name: 'Manzo macinato', quantity: '~275 g' },
          { id: 'b7-salmone', name: 'Salmone filetto', quantity: '~150 g' },
          { id: 'b7-cosce', name: 'Cosce di pollo disossate', quantity: '~133 g' },
          { id: 'b7-calamari', name: 'Calamari', quantity: '~83 g (+117 g HP)' },
          { id: 'b7-petto', name: 'Petto di pollo', quantity: '~75 g (+75 g HP)' },
          { id: 'b7-tofu-aff', name: 'Tofu affumicato', quantity: '~100 g (+300 g HP)' },
          { id: 'b7-tofu-duro', name: 'Tofu duro', quantity: '~67 g (+283 g HP)' },
          { id: 'b7-uova', name: 'Uova intere', quantity: 'Circa 2 uova' }
        ]
      },
      {
        title: 'Frigo',
        items: [
          { id: 'b7-latte', name: 'Latte', quantity: '~150 ml' },
          { id: 'b7-latte-mandorle', name: 'Latte di mandorle', quantity: '~62 ml' },
          { id: 'b7-yogurt-0', name: 'Yogurt greco 0%', quantity: '~50 g' },
          { id: 'b7-panna-cucina', name: 'Panna da cucina light', quantity: '~50 ml' },
          { id: 'b7-feta', name: 'Feta', quantity: '~38 g' },
          { id: 'b7-mozzarella', name: 'Mozzarella', quantity: '~31 g' },
          { id: 'b7-mozzarella-magra', name: 'Mozzarella magra', quantity: '~30 g' },
          { id: 'b7-panna-fresca', name: 'Panna fresca', quantity: '~25 ml' }
        ]
      }
    ],
    hpCorrections: [
    ...
    mealPrepSteps: [
      'Pasta verde: cuoci il tofu e pesa la pasta ridotta a 65 g; la salsa verde si conserva bene per 48 ore.',
      'Pasta al curry HP (giorno 26): pollo 150 g, pasta ~55 g, panna e mozzarella ridotte.',
      'Teriyaki: tofu ~200 g, quinoa ~65 g.',
      'Involtini: prepara 4 porzioni HP con tofu extra e friggi ad aria.',
      'Calamari: ~200 g cotti rapidamente per non indurire la polpa.'
    ],
    storageAdvice: 'Le pirofile cotte possono essere tagliate in 4 monoporzioni e surgelate singolarmente in carta stagnola/film termico.'
  },
  {
    id: 'block-29-31',
    daysRange: 'Giorni 29–31',
    startDay: 29,
    endDay: 31,
    categories: [
      {
        title: 'Frutta e Verdura',
        items: [
          { id: 'b8-banane', name: 'Banane', quantity: '~262 g' },
          { id: 'b8-pomodori', name: 'Pomodori', quantity: '~180 g' },
          { id: 'b8-zucchine', name: 'Zucchine', quantity: '~115 g' },
          { id: 'b8-spinaci', name: 'Spinaci', quantity: '~100 g' },
          { id: 'b8-spinacino', name: 'Spinacino', quantity: '~100 g' },
          { id: 'b8-valeriana', name: 'Valeriana', quantity: '~75 g' },
          { id: 'b8-carote', name: 'Carote', quantity: '~50 g' },
          { id: 'b8-cipolla', name: 'Cipolla', quantity: '~47 g' },
          { id: 'b8-aglio', name: 'Aglio', quantity: '~12 g' },
          { id: 'b8-cipollotti', name: 'Cipollotti', quantity: '~32 g' },
          { id: 'b8-lattuga', name: 'Lattuga', quantity: '~38 g' },
          { id: 'b8-limone', name: 'Limone', quantity: '~40 g' },
          { id: 'b8-germogli', name: 'Germogli mungo', quantity: '~12 g' }
        ]
      },
      {
        title: 'Proteine',
        items: [
          { id: 'b8-petto', name: 'Petto di pollo', quantity: '~325 g (+75 g HP)' },
          { id: 'b8-tofu-duro', name: 'Tofu duro', quantity: '~167 g (+363 g HP)' },
          { id: 'b8-tofu-aff', name: 'Tofu affumicato', quantity: '~25 g (+75 g HP)' },
          { id: 'b8-uova', name: 'Uova intere', quantity: 'Circa 2 uova' }
        ]
      },
      {
        title: 'Frigo',
        items: [
          { id: 'b8-latte-mandorle', name: 'Latte di mandorle', quantity: '~262 ml' },
          { id: 'b8-latte', name: 'Latte', quantity: '~38 ml' },
          { id: 'b8-yogurt', name: 'Yogurt', quantity: '~60 g' },
          { id: 'b8-yogurt-greco', name: 'Yogurt greco', quantity: '~100 g' },
          { id: 'b8-yogurt-0', name: 'Yogurt greco 0%', quantity: '~50 g' },
          { id: 'b8-panna-acida', name: 'Panna acida', quantity: '~60 g' }
        ]
      }
    ],
    hpCorrections: [
      ...
      'Petto di pollo: +~75 g',
      'Tofu duro: +~363 g',
      'Tofu affumicato: +~75 g',
      'Albumi: +~200 g',
      'Usa ~50 g di banana in meno.'
    ],
    mealPrepSteps: [
      'Giorno 29 Mug Cake originale: non aggiungere whey.',
      'Prepara tofu extra per riso fritto, teriyaki e pasta verde.',
      'Tikka Masala: porziona pollo e riso secondo la variante HP.',
      'Frittelle HP: aggiungi 100 g di albumi e misura l\'olio con precisione.',
      'Ultimo blocco: consuma gli avanzi di whey e skyr della dispensa prima di aprire nuove confezioni.'
    ],
    storageAdvice: 'Chiudi il ciclo mensile verificando la dispensa per il rinnovo del mese successivo!'
  }
];
