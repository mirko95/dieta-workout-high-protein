    ...
    workouts: [
      {
        ...
        exercises: [
          ...
          { name: 'Crunch Machine', sets: '2', reps: '12–15', restSeconds: 60, restLabel: '45–60', notes: 'Espira in contrazione', gifUrl: 'https://my-trakk.com/media/instructional-videos/inst_gif_158.gif' },
          { name: 'Dumbbell Wrist Extension', sets: '3', reps: '12–15', restSeconds: 60, restLabel: '45–60' },
          { name: 'Dumbbell Forearm Rotation', sets: '2', reps: '12–15 per braccio', restSeconds: 60, restLabel: '45–60' }
        ]
      },
      {
        id: 'set-b',
        ...
        exercises: [
          ...
          { name: 'Plank', sets: '2', reps: '30–45 s', restSeconds: 60, notes: 'Addome e glutei contratti', gifUrl: 'https://media2.giphy.com/media/BWRHz2mlwxTIHMlNS6/giphy.gif?cid=790b7611a387e602b6ae3476e9445416dfe3dc64d9272e74&ct=g&rid=giphy.gif' },
          { name: 'Cable Wrist Extension', sets: '3', reps: '12–15', restSeconds: 60, restLabel: '45–60' },
          { name: 'Dumbbell Forearm Rotation', sets: '2', reps: '12–15 per braccio', restSeconds: 60, restLabel: '45–60' }
        ]
      },
      {
        ...
        exercises: [
          ...
          { name: 'Calf Raise', sets: '2', reps: '12–15', restSeconds: 60, notes: 'Massima estensione in basso', gifUrl: 'https://cdnl.iconscout.com/lottie/premium/thumb/man-doing-lever-standing-calf-raise-exercise-for-legs-animation-gif-download-9729938.gif' },
          { name: 'Addome alla macchina', sets: '2', reps: '12–15', restSeconds: 60, restLabel: '45–60', notes: '45-60s recupero', gifUrl: 'https://my-trakk.com/media/instructional-videos/inst_gif_158.gif' },
          { name: 'Dumbbell Wrist Extension', sets: '3', reps: '12–15', restSeconds: 60, restLabel: '45–60' },
          { name: 'Dumbbell Forearm Rotation', sets: '2', reps: '12–15 per braccio', restSeconds: 60, restLabel: '45–60' }
        ]
      }
    ...
    workouts: [
      {
        ...
        exercises: [
          ...
          { name: 'Seated Row presa neutra', sets: '3', reps: '8–12', restSeconds: 90, notes: 'Tirata controllata' },
          { name: 'Leg Curl seduto', sets: '3', reps: '10–15', restSeconds: 75, notes: 'Contrazione di picco 1s' },
          { name: 'Alzate laterali alla macchina', sets: '2', reps: '12–15', restSeconds: 60, notes: 'Isolamento spalle' },
          { name: 'Crunch Machine', sets: '2', reps: '12–15', restSeconds: 60, restLabel: '45–60', notes: 'Addome' },
          { name: 'Dumbbell Wrist Extension', sets: '3', reps: '12–15', restSeconds: 60, restLabel: '45–60' },
          { name: 'Dumbbell Forearm Rotation', sets: '2', reps: '12–15 per braccio', restSeconds: 60, restLabel: '45–60' }
        ]
      },
      {
        ...
        exercises: [
          ...
          { name: 'Lat Machine presa neutra', sets: '3', reps: '8–12', restSeconds: 90, notes: 'Trazione verticale' },
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Addome alla macchina', sets: '2', reps: '12–15', restSeconds: 60, restLabel: '45–60', notes: 'Addominali' },
          { name: 'Dumbbell Wrist Extension', sets: '3', reps: '12–15', restSeconds: 60, restLabel: '45–60' },
          { name: 'Dumbbell Forearm Rotation', sets: '2', reps: '12–15 per braccio', restSeconds: 60, restLabel: '45–60' }
        ]
      }
